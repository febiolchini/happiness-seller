...
const SHOTS := [
	...
	[Vector2(6344, 8470), 13.0, "clear", "isolato_dt_giorno", 3],
	[Vector2(6344, 8470), 22.0, "clear", "isolato_dt_notte", 3],
	# Lo STAR CASINO, l'isolato intero a sinistra del grossista.
	[Vector2(3920, 264), 13.0, "clear", "casino_giorno", 2],
	[Vector2(3920, 264), 22.0, "clear", "casino_notte", 2],
	# Il negozio di videogiochi e il cinema su CROSS STREET, col parcheggio.
	[Vector2(5500, 968), 13.0, "clear", "cinema_giorno", 3],
	[Vector2(5500, 968), 22.0, "clear", "cinema_notte", 3],
	...
	[Vector2(559, 970), 13.0, "clear", "bici_giorno", -1],
	[Vector2(559, 970), 13.0, "clear", "bici_vicino", 5],
	[Vector2(559, 970), 22.5, "clear", "bici_notte", -1],
	...
	# L'isolato cinese, a est di MILL ROAD. Il largo (livello 3) serve perche'
	...
	[Vector2(1215, 264), 13.0, "clear", "cinese_giorno", 3],
	[Vector2(1215, 264), 22.5, "clear", "cinese_notte", 3],
	[Vector2(980, 264), 13.0, "clear", "cinese_ristorante", -1],
	# Da vicino (scala netta 3, la piu' vicina): serve a giudicare il dettaglio, che a questa
	# scala e' l'unica cosa che si vede.
	[Vector2(980, 264), 13.0, "clear", "cinese_zoom", 5],
	...
	[Vector2(1683, 264), 13.0, "clear", "officina_zoom", 5],
	# Il grossista dei semi, su MAIN STREET nel quartiere commerciale. Il largo
	# (livello 3) perché lo sprite è largo 632 px. Serve a controllare due cose
	...
	# sua fascia.
	[Vector2(4783, 264), 13.0, "clear", "grossista_giorno", 3],
	[Vector2(4783, 264), 22.5, "clear", "grossista_notte", 3],
	...
	[Vector2(4712, 3520), 13.0, "clear", "quartieri_est", 3],
	# I due confini: commerciale/hillside su FOUNDRY ROW (y~1728) e
	# hillside/downtown su RIVER ROW (y~5712). Livello 1 (molto largo) per
	# vedere il cambio di colore del terreno da un lato all'altro della strada.
	[Vector2(4712, 1728), 13.0, "clear", "confine_commerciale_hillside", 1],
	[Vector2(4712, 5712), 13.0, "clear", "confine_hillside_downtown", 1],
	...
	# Livello 0 (scala netta 0,25) perche' la Meridian e' alta 2316 px e alla
	# vista di default se ne vedrebbe un ottavo.
	[Vector2(5535, 8470), 8.0, "clear", "torri_mattina", 0],
	[Vector2(5535, 8470), 13.0, "clear", "torri_mezzogiorno", 0],
	[Vector2(5535, 8470), 18.2, "clear", "torri_sera", 0],
	[Vector2(5535, 8470), 22.0, "clear", "torri_notte", 0],
	[Vector2(5535, 8470), 13.0, "rain", "torri_pioggia", 0],
	[Vector2(5535, 8470), 13.0, "clear", "torri_piede", 3],
	...
	[Vector2(4900, 8470), 13.0, "clear", "holly_giorno", 3],
	[Vector2(4900, 8470), 22.0, "clear", "holly_notte", 3],
	[Vector2(4800, 8470), 13.0, "clear", "holly_vicino", -1],
	# Il campo da football abbandonato. Il largo (livello 3 = scala netta 1)
	# serve perche' il campo e' largo 736 px e alla vista di default se ne
	# vedono 640: la gradinata ci sta tutta solo allargando.
	[Vector2(304, 700), 13.0, "clear", "campo_giorno", 3],
	[Vector2(304, 700), 13.0, "clear", "campo_vicino", -1],
	[Vector2(304, 700), 22.5, "clear", "campo_notte", 3],
	# UNION PARK, lo stadio, nell'isolato d'angolo fra EAST STREET e SOUTH
	# GATE. Il largo (livello 3) perché lo sprite è largo 646 px e alla vista di
	...
	[Vector2(3128, 6350), 13.0, "clear", "stadio_giorno", 3],
	[Vector2(3128, 6350), 22.5, "clear", "stadio_notte", 3],
	...
	[Vector2(3472, 6060), 13.0, "clear", "stadio_east_street", 3],
]
